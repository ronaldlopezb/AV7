<?php
	require_once('datos-activar-cuenta.php');
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="page-container">
			...
			<div class="page-content">
				...
				<?php
					...
					if ($Mensaje==1){
						//Se envió un Email de confirmación a su correo electrónico
						require_once('envio-email-confirmacion.php');
						exit();
					}
					...
					if ($Mensaje==2){
						...
						require_once('activar-confirmacion.php');
						exit();
					}

					if ($Mensaje==0){
						//Muestra Formulario para recuperar Contraseña
						require_once('activar.php');
						exit();
					}
