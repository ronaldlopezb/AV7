...
<div class="content-wrapper">
	...
	<div class="profile-cover">
		<div class="profile-cover-img" style="background-image: url(img/cover2.jpg)"></div>
		<div class="media">
			<div class="media-left">
				<a href="#" class="profile-thumb">
					<img src="<?php echo $RutaServidor.$PerfilFotografia; ?>" class="img-circle" alt="<?php echo $PerfilNombre.' '.$PerfilApePaterno.' '.$PerfilApeMaterno; ?>">
				</a>
			</div>

			<div class="media-body">
	    		<h1><?php echo $PerfilNombre.' '.$PerfilApePaterno.' '.$PerfilApeMaterno; ?><small class="display-block"><?php echo $PerfilProfesion; ?></small></h1>
			</div>
									...
									<div class="panel panel-flat timeline-content">
										...
										<div class="panel-body">
											<a href="#" class="display-block content-group">
												<img src="img/cover3.jpg" class="img-responsive content-group" alt="">
											</a>
												...
												<li class="media reversed">
													...
													<div class="media-right">
														<a href="assets/images/placeholder.jpg">
															<img src="img/face2.jpg" class="img-circle" alt="">
														</a>
													</div>
												</li>
				...
				<ul class="media-list media-list-linked pb-5">
					...
					<li class="media">
						<a href="#" class="media-link">
							<div class="media-left"><img src="img/face3.jpg" class="img-circle" alt=""></div>
							<div class="media-body">
					...
					<li class="media">
						<a href="#" class="media-link">
							<div class="media-left"><img src="img/face4.jpg" class="img-circle" alt=""></div>
							<div class="media-body">
					...
					<li class="media">
						<a href="#" class="media-link">
							<div class="media-left"><img src="img/face5.jpg" class="img-circle" alt=""></div>
							<div class="media-body">
					...
					<li class="media">
						<a href="#" class="media-link">
							<div class="media-left"><img src="img/face6.jpg" class="img-circle" alt=""></div>
							<div class="media-body">
					...
					<li class="media">
						<a href="#" class="media-link">
							<div class="media-left"><img src="img/face9.jpg" class="img-circle" alt=""></div>
							<div class="media-body">
					...
					<li class="media">
						<a href="#" class="media-link">
							<div class="media-left"><img src="img/face11.jpg" class="img-circle" alt=""></div>
							<div class="media-body">
					...
					<li class="media">
						<a href="#" class="media-link">
							<div class="media-left"><img src="img/face24.jpg" class="img-circle" alt=""></div>
							<div class="media-body">
